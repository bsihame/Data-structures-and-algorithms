...
console.log("=======================================================");
console.log("Contains Duplicate in an array");
...
function containsDuplicate(nums) {
  ...
  for (let i = 0; i < nums.length; i++) {
    if (!frequencyLetter[nums[i]]) {
      frequencyLetter[nums[i]] = 1;
    } else {
      return true;
    }
  }
...
console.log(singleNumber([1, 3, 1, 4, 4, 5, 5])); // 3
